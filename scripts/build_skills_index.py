#!/usr/bin/env python3
"""Build the Tampinha Skills Index — a centralized JSON catalog of all skills.
...
`tampinha skills search/install` can use it without hitting the GitHub API.
...
# Ensure TAMPINHA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Tampinha Skills Index...", flush=True)
