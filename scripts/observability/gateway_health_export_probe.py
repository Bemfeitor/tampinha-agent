...
def main() -> None:
    ...
    tampinha_home = Path(tempfile.mkdtemp(prefix="tampinha-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "tampinha-gateway-smoke",
    ...
    print(json.dumps({"tampinha_home": str(tampinha_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
