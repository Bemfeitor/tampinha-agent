#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Tampinha logs.
...
With no LOGFILE, reads ``$TAMPINHA_HOME/logs/agent.log`` (default ~/.tampinha).
...
def default_log() -> Path:
    home = os.environ.get("TAMPINHA_HOME") or str(Path.home() / ".tampinha")
