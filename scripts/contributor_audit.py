...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Tampinha\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (tampinha-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "tampinha@nousresearch.com",
    "tampinha-audit@example.com",
    "nousbot@nousresearch.com",
    "tampinha@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
