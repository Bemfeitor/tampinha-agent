#!/usr/bin/env python3
"""Build the Tampinha Model Catalog — a centralized JSON manifest of curated models.
...
Tampinha CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Tampinha release.
...
# Ensure TAMPINHA_HOME is set for imports that touch it at module level.
os.environ.setdefault("TAMPINHA_HOME", os.path.join(os.path.expanduser("~"), ".tampinha"))

from tampinha_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Tampinha '
