...
the contract that subsequent turns echo it back; combined with how Tampinha
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Tampinha remaps
the retired IDs in ``tampinha_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Tampinha, so they are not listed here.
    """
