...
request omits ``thinking``.  Tampinha' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Tampinha reasoning
...
(per Z.AI / BigModel docs).  Tampinha' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Tampinha reasoning effort onto GLM's native vocabulary.
