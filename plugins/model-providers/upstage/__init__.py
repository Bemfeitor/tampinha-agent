...
# When the user hasn't picked a reasoning effort, Tampinha passes
...
# ON at this effort — matching the "medium (default)" that Tampinha' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Tampinha' effort vocabulary onto Solar's accepted set via the
