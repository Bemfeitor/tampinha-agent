...
Config: ~/.tampinha/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.tampinha/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_tampinha_home()`` helper (TAMPINHA_HOME-aware and
...
RULES_FILE = get_tampinha_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_tampinha_home() / "feishu_comment_pairing.json"
