...
required — uses aiohttp which is already a Tampinha dependency.
...
def interactive_setup() -> None:
    ...
    ``tampinha_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Tampinha delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # tampinha_cli/setup.py::_setup_mattermost function.
