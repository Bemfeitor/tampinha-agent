...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Tampinha gateway adapter.

    Each inbound phone number gets its own Tampinha session (multi-tenant).
...
# static dict in tampinha_cli/gateway.py, and the _send_sms dispatch in
