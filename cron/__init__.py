"""
Cron job scheduling system for Tampinha Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    tampinha gateway install    # Install as a user service
    sudo tampinha gateway install --system  # Linux servers: boot-time system service
    tampinha gateway            # Or run in foreground
