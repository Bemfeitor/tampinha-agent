...
(3 SDK retries x 3 Tampinha retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_tampinha_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".tampinha")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Tampinha, ...) behind one endpoint.  A 429 can mean either:
