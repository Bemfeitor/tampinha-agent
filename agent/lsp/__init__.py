"""Language Server Protocol (LSP) integration for Tampinha Agent.

Tampinha runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``tampinha chat`` exit would leak pyright processes that
