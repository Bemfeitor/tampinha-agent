...
# ``data:`` field before Tampinha receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Tampinha persists a content-less
...
# Request parameters that Tampinha sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # tampinha_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from tampinha_cli.plugins import get_plugin_error_classification
