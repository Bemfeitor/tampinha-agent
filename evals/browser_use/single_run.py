...
The run gets a throwaway TAMPINHA_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE TAMPINHA_HOME is redirected to the
