...
Data file: $TAMPINHA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_TAMPINHA_HOME = Path(os.environ.get("TAMPINHA_HOME", Path.home() / ".tampinha"))
DATA_DIR = _TAMPINHA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
