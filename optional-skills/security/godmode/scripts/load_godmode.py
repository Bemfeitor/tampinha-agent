...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("TAMPINHA_HOME", os.path.expanduser("~/.tampinha")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("TAMPINHA_HOME", Path.home() / ".tampinha")) / "skills" / "red-teaming" / "godmode" / "scripts"
