...
def _state_dir() -> Path:
    ...
    # Default: $TAMPINHA_HOME/watcher-state/, falling back to ~/.tampinha/watcher-state/.
    tampinha_home = os.environ.get("TAMPINHA_HOME") or str(Path.home() / ".tampinha")
    return Path(tampinha_home) / "watcher-state"
