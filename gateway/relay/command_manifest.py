...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Tampinha session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Tampinha session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Tampinha agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Tampinha Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Tampinha gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Tampinha session in it",
