...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$TAMPINHA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_tampinha_dir("platforms/whatsapp/session", "whatsapp/session")
