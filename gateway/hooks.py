...
Hooks are discovered from ~/.tampinha/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Tampinha session id
...
HOOKS_DIR = get_tampinha_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"tampinha_hook_{hook_name}"
