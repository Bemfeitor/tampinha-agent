...
from environment variables:
  ...
  - ``TAMPINHA_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``TAMPINHA_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``TAMPINHA_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``tampinha cron run`` in the CLI, ``tampinha send``, a
...
_STRICT_ENV = "TAMPINHA_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "TAMPINHA_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "TAMPINHA_MEDIA_TRUST_RECENT_FILES"
