...
def _profile_user_agent() -> str:
    """Return a ``tampinha-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from tampinha_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"tampinha-cli/{_ver}"
    except Exception:
        return "tampinha-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # tampinha-cli UA so the catalog endpoint is reachable.
