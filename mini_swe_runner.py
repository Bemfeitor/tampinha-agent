#!/usr/bin/env python3
"""
SWE Runner with Tampinha Trajectory Format

A runner that uses Tampinha-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Tampinha-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Tampinha-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Tampinha format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Tampinha-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Tampinha-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Tampinha Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Tampinha-Agent's built-in execution environments
    and outputs trajectories in Tampinha-Agent format.
    """
    ...
    def _convert_to_tampinha_format(
        self,
        ...
        """
        Convert internal message format to Tampinha trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Tampinha trajectory format
        trajectory = self._convert_to_tampinha_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Tampinha trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Tampinha Trajectory Format")
    print("=" * 60)
