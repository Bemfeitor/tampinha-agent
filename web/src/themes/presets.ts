 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `tampinha_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Tampinha Teal",
  description: "Classic dark teal — the canonical Tampinha look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Tampinha Teal (Large)",
  description: "Tampinha Teal with bigger fonts and roomier spacing",
