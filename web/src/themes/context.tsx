...
const STORAGE_KEY = "tampinha-dashboard-theme";
...
const FONT_STORAGE_KEY = "tampinha-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `tampinha_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "tampinha-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-tampinha-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-tampinha-theme-font", "true");
