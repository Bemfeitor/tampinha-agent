 ...
 *
 * Values mirror tampinha_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Tampinha default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Tampinha' default when unset). */
