...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Tampinha",
    updateHermesConfirmMessage:
      "This runs tampinha update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Tampinha?",
    updatingHermes: "Updating Tampinha…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Tampinha plugins (`tampinha plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.tampinha/plugins/?",
    removeHint: "Only user-installed plugins under ~/.tampinha/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.tampinha/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Tampinha doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Tampinha badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Tampinha session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Tampinha more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Tampinha sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Tampinha is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
