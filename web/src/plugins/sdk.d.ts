/**
 * Tampinha Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__TAMPINHA_PLUGIN_SDK__`` and
 * ``window.__TAMPINHA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__TAMPINHA_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@tampinha/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__TAMPINHA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__TAMPINHA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__TAMPINHA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __TAMPINHA_PLUGIN_SDK__?: HermesPluginSDK;
    __TAMPINHA_PLUGINS__?: PluginRegistry;
  }
}
