 ...
 * `window.__TAMPINHA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Tampinha brand in the top bar
 ...
 *  `window.__TAMPINHA_PLUGINS__.registerSlot(...)`.
 *
