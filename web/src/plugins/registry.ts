 ...
 *
 * Plugins call window.__TAMPINHA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__TAMPINHA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__TAMPINHA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__TAMPINHA_PLUGIN_SDK__ = {
    ...
    // window.__TAMPINHA_SESSION_TOKEN__ directly.
    authedFetch,
