...
const TAG_FULL = 'Bemfeitor · Inteligência a Serviço de Todos'
const TAG_MID = 'Inteligência a Serviço de Todos'
const TAG_TINY = 'Bemfeitor'
const HIDE_BELOW = 34
  ...
  const heroColumn = wide ? (
    <Box flexDirection="column" width="100%">
      ...
      <Text color={t.color.accent}>
        ...
        <Text color={t.color.muted}> · Bemfeitor</Text>
      </Text>
