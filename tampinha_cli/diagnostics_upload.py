"""Client for uploading ``tampinha debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``tampinha debug share``.
...
NAS_BASE = os.environ.get(
    "TAMPINHA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "tampinha-agent/debug-share"
