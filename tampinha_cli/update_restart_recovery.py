...
_RECOVERY_ENV = "TAMPINHA_UPDATE_RESTART_RECOVERY"
_GATEWAY_MARKERS = ("_TAMPINHA_GATEWAY", "TAMPINHA_GATEWAY", "TAMPINHA_GATEWAY_MODE")
...
def _systemd_unit_candidates(profile: str) -> tuple[str, ...]:
    ...
    if profile == "default":
        return (
            "tampinha-gateway.service",
            "gateway.service",
            "gateway-default.service",
        )
    return (
        f"tampinha-gateway-{profile}.service",
