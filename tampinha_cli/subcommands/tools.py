"""``tampinha tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'tampinha tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # tampinha tools list [--platform cli]
    ...
    # tampinha tools disable <name...> [--platform cli]
    ...
    # tampinha tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `tampinha tools` runs after you pick a provider that\n"
