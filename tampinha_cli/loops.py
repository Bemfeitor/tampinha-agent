...
Design notes / invariants (same contract as ``tampinha_cli/goals.py``):
...
def _get_session_db() -> Optional[Any]:
    ...
    """
    try:
        from tampinha_cli.goals import _get_session_db as _goals_db
...
def save_loop(session_id: str, state: LoopState) -> None:
    ...
    db = _get_session_db()
    if db is None:
        from tampinha_cli.goals import _warn_dropped_write
