...
Invoked by ``tampinha kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Tampinha Agent board.
...
def _profile_author() -> str:
    """Mirror of ``tampinha_cli.kanban._profile_author``."""
    return (
