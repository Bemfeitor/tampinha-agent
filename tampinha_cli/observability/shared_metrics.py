"""Durable aggregation and local export for Tampinha shared metrics."""
...
from tampinha_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "tampinha.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_tampinha_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "tampinha_version": row["tampinha_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Tampinha processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "tampinha_version": period_row["tampinha_version"],
