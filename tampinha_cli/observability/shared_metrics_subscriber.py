"""Relay subscriber for the persisted Tampinha shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Tampinha counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        tampinha_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Tampinha shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
