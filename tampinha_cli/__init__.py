"""
Tampinha CLI - Unified command-line interface for Tampinha Agent.

Provides subcommands for:
- tampinha chat          - Interactive chat (same as ./tampinha)
- tampinha gateway       - Run gateway in foreground
- tampinha gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `tampinha setup` on a fresh Pi.
    ...
    tampinha_cli/stdio.py::configure_windows_stdio() runs later from the entry
