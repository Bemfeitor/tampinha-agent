...
Entry point: ``tampinha whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``tampinha_cli/main.py``).
...
Tampinha gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Tampinha to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Tampinha needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Tampinha gateway in another terminal:")
    print("         tampinha gateway")
    print()
