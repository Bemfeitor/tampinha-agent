...
Trust levels:
  - builtin:   Ships with Tampinha. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.tampinha/\.env|\~/\.tampinha/\.env',
     "tampinha_env_access", "critical", "exfiltration",
     "directly references Tampinha secrets file"),
    ...
    (r'\.tampinha/config\.yaml|\.tampinha/SOUL\.md',
     "tampinha_config_mod", "critical", "persistence",
     "references Tampinha configuration files directly"),
...
# scan. `.skillignore` is the Tampinha-native name; `.clawhubignore` is honored
