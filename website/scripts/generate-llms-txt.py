#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Tampinha docs site.
...
LLM reads to learn what Tampinha does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Tampinha as a Python Library", None),
        ("guides/use-mcp-with-tampinha", "Use MCP with Tampinha", None),
        ("guides/use-voice-mode-with-tampinha", "Use Voice Mode with Tampinha", None),
        ("guides/use-soul-with-tampinha", "Use SOUL.md with Tampinha", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Tampinha"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "tampinha-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Tampinha Agent — Full Documentation\n",
        (
            "This file is the entire Tampinha Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Tampinha, Features, Messaging, Integrations, Guides, "
