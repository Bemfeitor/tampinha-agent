...
The official Codex endpoint must receive Tampinha' own harness identity, rather
...
These tests pin:
- the required Tampinha originator
- the versioned Tampinha User-Agent
...
class TestCodexCloudflareHeaders:
    ...
    def test_user_agent_advertises_tampinha_version(self):
...
class TestPrimaryClientWiring:
    ...
    def test_apply_client_headers_on_base_url_change(self):
        ...
        with patch("run_agent.OpenAI") as mock_openai:
            ...
            assert headers.get("originator") == "tampinha-agent"
