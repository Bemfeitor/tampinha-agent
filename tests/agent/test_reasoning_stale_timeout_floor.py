...
thinking phase.  Tampinha's default cloud-stream stale detector
(``TAMPINHA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``TAMPINHA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
