"""Tests for _setup_feishu() in tampinha_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("tampinha_cli.config.save_env_value", side_effect=mock_save), \
         patch("tampinha_cli.config.get_env_value", side_effect=mock_get), \
         patch("tampinha_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("tampinha_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("tampinha_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("tampinha_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("tampinha_cli.cli_output.print_header"), \
         patch("tampinha_cli.cli_output.print_info"), \
         patch("tampinha_cli.cli_output.print_success"), \
         patch("tampinha_cli.cli_output.print_warning"), \
         patch("tampinha_cli.cli_output.print_error"), \
