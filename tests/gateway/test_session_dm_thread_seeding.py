...
def store(tmp_path, monkeypatch):
    ...
    ~/.tampinha/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at tampinha_state import time, before pytest's TAMPINHA_HOME monkeypatch
    fires — the autouse fixture's TAMPINHA_HOME override doesn't help here.)
    """
