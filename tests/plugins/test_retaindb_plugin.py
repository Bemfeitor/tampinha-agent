...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure TAMPINHA_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", tampinha_home=str(tmp_path / ".tampinha"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("TAMPINHA_HOME", str(tampinha_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", tampinha_home=str(tampinha_home))
        return p
