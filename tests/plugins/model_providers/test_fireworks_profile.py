...
class TestFireworksHeaders:
    def test_attribution_matches_canonical_tampinha_values(self, fireworks_profile):
        """Fireworks requests carry the same attribution identity Tampinha sends
        everywhere else.
    ...
    def test_user_agent_identifies_tampinha(self, fireworks_profile):
