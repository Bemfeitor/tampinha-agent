...
from tampinha_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/tampinha_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("tampinha_cli.lifecycle.invoke_hook")
@patch("tampinha_cli.lifecycle.finalize_session")
