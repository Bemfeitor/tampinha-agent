...
* ``tampinha_constants.get_tampinha_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_tampinha_dir so cache writes land under tmp_path."""
    ...
    with patch("tampinha_constants.get_tampinha_dir", _fake_get):
        yield cache_dir
