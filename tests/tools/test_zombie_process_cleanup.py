...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from tampinha_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["tampinha_home"] = get_tampinha_home()
        ...
        assert observed["tampinha_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_tampinha_home_override(profile_home)
        ...
        try:
            ...
            release_child.set()
            reset_tampinha_home_override(profile_token)
            relay_runtime._reset_for_tests()
