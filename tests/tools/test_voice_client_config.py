...
Real config files in a temp TAMPINHA_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated TAMPINHA_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "TAMPINHA_LOCAL_STT_LANGUAGE",
    ):
