...
def test_tampinha_provider_subclass_exists():
    """HermesMCPOAuthProvider is defined and subclasses OAuthClientProvider."""
    from tools.mcp_oauth_manager import _TAMPINHA_PROVIDER_CLS
    from mcp.client.auth.oauth2 import OAuthClientProvider

    assert _TAMPINHA_PROVIDER_CLS is not None
    assert issubclass(_TAMPINHA_PROVIDER_CLS, OAuthClientProvider)
