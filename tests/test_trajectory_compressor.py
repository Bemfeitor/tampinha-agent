...
def test_import_loads_env_from_tampinha_home(tmp_path, monkeypatch):
    home = tmp_path / ".tampinha"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-tampinha-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-tampinha-home"
