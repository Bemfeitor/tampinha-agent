"""Regression test: tampinha update must not load cryptography eagerly."""
...
assert 'tampinha_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running tampinha update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so tampinha_cli is importable,
...
import tampinha_cli.main
from tampinha_cli.update_cmd import _cmd_update_check
