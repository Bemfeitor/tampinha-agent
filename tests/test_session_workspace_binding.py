"""Session <-> workspace grouping key (tampinha_state.workspace_key).

The key is what `tampinha sessions list --workspace` groups/filters on. It is a
...
from tampinha_state import workspace_key
