...
def make_tampinha_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated TAMPINHA_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"tampinha-home-{journal_mode}"
