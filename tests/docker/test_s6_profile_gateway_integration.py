...
The unit tests in tests/tampinha_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned tampinha-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/tampinha")
from tampinha_cli.service_manager import S6ServiceManager
