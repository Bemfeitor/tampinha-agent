...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from tampinha_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in TAMPINHA_OVERLAYS
        overlay = TAMPINHA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify tampinha doctor recognizes Xiaomi env vars."""
