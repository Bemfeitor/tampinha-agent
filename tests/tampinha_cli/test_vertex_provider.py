...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (tampinha_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_tampinha_overlays():
    """tampinha_cli.providers.get_provider("vertex") backs
