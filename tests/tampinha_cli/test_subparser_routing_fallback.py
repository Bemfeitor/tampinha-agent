...
The main() function in tampinha_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `tampinha -c model`
...
def _build_parser():
    """Build a minimal replica of the tampinha top-level parser."""
