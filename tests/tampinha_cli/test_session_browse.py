"""Tests for the interactive session browser (`tampinha sessions browse`).
...
from tampinha_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """tampinha sessions browse should be parseable."""
