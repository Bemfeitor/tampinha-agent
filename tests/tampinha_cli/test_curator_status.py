"""Tests for `tampinha curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated TAMPINHA_HOME with real agent-created skills on disk."""
    ...
    from tampinha_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import tampinha_cli.curator as curator_cli
