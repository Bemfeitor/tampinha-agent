"""Tests for the specifier module + `tampinha kanban specify` CLI surface.
...
from tampinha_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `tampinha kanban …` argparse surface directly."""
