"""Tests for `tampinha chat --safe-mode` isolation."""
...
_VARS = ("TAMPINHA_SAFE_MODE", "TAMPINHA_IGNORE_USER_CONFIG", "TAMPINHA_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["TAMPINHA_SAFE_MODE"] == "1"
        assert os.environ["TAMPINHA_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["TAMPINHA_IGNORE_RULES"] == "1"
        return True
