"""Regression: tampinha doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at tampinha_cli/doctor.py already covers
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from tampinha_cli import doctor
