"""Tests for the shared byte formatter (tampinha_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from tampinha_cli.backup import _format_size as backup
    from tampinha_cli.checkpoints import _fmt_bytes as checkpoints
    from tampinha_cli.doctor import _human_bytes as doctor
