"""Tests for `tampinha secrets bitwarden token` / `tampinha secrets onepassword token`.
...
from tampinha_cli import onepassword_secrets_cli as op_cli
from tampinha_cli import secrets_cli as bw_cli
