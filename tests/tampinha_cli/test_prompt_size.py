"""Tests for the ``tampinha prompt-size`` diagnostic (issue #34667)."""
...
from tampinha_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(tampinha_home, memory_text="", user_text=""):
    mem_dir = tampinha_home / "memories"
...
def _seed_skill(tampinha_home, name, description):
    skill_dir = tampinha_home / "skills" / "demo" / name
