"""Tests for ``tampinha approvals suggest`` (tampinha_cli/approvals_suggest.py).

Approval history in Tampinha is implied, not ledgered: the session DB
...
from tampinha_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
