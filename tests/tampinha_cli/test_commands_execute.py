...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`tampinha_cli.slash_exec.EXECUTORS`, and
...
from tampinha_cli.commands import COMMAND_REGISTRY, resolve_command
from tampinha_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
