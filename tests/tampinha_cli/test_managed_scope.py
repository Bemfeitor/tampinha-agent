"""Unit tests for tampinha_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub TAMPINHA_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "TAMPINHA_MANAGED_DIR" not in os.environ
