...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Tampinha 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Tampinha 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Tampinha 🚀"
...
"""
    env = dict(os.environ, TAMPINHA_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
