...
class TestGetCopilotModelContext:
    ...
    @patch("tampinha_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("tampinha_cli.models._urlopen_model_catalog_request")
    ...
    @patch("tampinha_cli.models.fetch_github_model_catalog", return_value=[])
