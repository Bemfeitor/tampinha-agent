"""Dashboard Tampinha Console websocket tests."""
...
@pytest.fixture
def console_client(monkeypatch, _isolate_tampinha_home):
...
def test_console_ws_cancel_returns_to_prompt(console_client, monkeypatch):
    from tampinha_cli.console_engine import ConsoleResult, HermesConsoleEngine
    ...
    with console_client.websocket_connect(_url()) as conn:
        ...
        assert complete["prompt"] == "tampinha> "
