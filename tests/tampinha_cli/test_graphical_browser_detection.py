"""Tests for `_can_open_graphical_browser()` in tampinha_cli.auth.

Guards the fix for the May 2026 report where `tampinha auth add xai-oauth`
...
from tampinha_cli.auth import _can_open_graphical_browser
