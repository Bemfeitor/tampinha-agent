"""Regression: ``tampinha update`` should take a managed checkout off autocrlf=true.
...
``tampinha update`` has to repair them.
...
from tampinha_cli.update_cmd import _normalize_managed_eol
