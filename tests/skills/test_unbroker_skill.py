...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and tampinha-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # tampinha-agent (tests/skills/)
]
